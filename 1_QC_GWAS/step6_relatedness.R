pdf("./outputs/step6_relatedness/relatedness.pdf")
relatedness = read.table("./outputs/step6_relatedness/pihat_min0.2.genome", header=T)
par(pch=16, cex=1)
...
pdf("./outputs/step6_relatedness/zoom_relatedness.pdf")
relatedness_zoom = read.table("./outputs/step6_relatedness/zoom_pihat.genome", header=T)
par(pch=16, cex=1)
...
pdf("./outputs/step6_relatedness/hist_relatedness.pdf")
relatedness = read.table("./outputs/step6_relatedness/pihat_min0.2.genome", header=T)
